...
namespace Syft {
    ...
    Parser Parser::read_from_file(const std::string &syfco_location, const std::string &filename) {
        ...
        std::string cmd_get_formula = "./" + syfco_location + " --format ltlxba-fin -m fully "+filename;
        std::string formula_str = parser.exec(cmd_get_formula.c_str());
        parser.formula = parser.trim(formula_str);

        std::string cmd_get_ins = "./" + syfco_location + " --format ltlxba-fin --print-input-signals "+filename;
        ...
        std::string cmd_get_outs = "./" + syfco_location + " --format ltlxba-fin --print-output-signals "+filename;
