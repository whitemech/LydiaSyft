...
namespace Syft {
    ...
    FairnessLtlfSynthesizer::FairnessLtlfSynthesizer(const SymbolicStateDfa &spec, Player starting_player,
    ...
    CUDD::BDD FairnessLtlfSynthesizer::load_CNF(const std::string &filename) const {
