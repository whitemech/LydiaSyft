...
namespace Syft {
    ...
    public:
        ...
        void dump_maxset_if_enabled(const ReachabilityMaxSetSynthesizer& maxset_synthesizer, const MaxSet& maxset_strategy, const std::string& def_strategy_output_file = "def_strategy.dot", const std::string& nondef_strategy_output_file = "nondef_strategy.dot") const;
